/datum/sprite_accessory/hair/resomi
	...
	icon = 'modular_vesta/icons/mob/human_races/species/teshari/hair.dmi'
	icon_state = "resomi_default"
	species_allowed = list(SPECIES_TESHARI)

/datum/sprite_accessory/hair/resomi/gentle //Effectively bald for the Teshari
	name = "Teshari Gentle"
	icon_state = "resomi_unused"
